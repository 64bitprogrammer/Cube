<?php
  ...
  $insert_query = "insert into found_items_tb (title,state,city,main_category,sub_category,primary_color,secondary_color,date,location,pincode,description,model,user)

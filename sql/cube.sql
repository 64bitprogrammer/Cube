...
CREATE TABLE IF NOT EXISTS `signup` (
  `id` int(8) NOT NULL AUTO_INCREMENT COMMENT 'Unique id',
  `fname` text,
  `lname` text,
...
INSERT INTO `signup` (`id`, `fname`, `lname`, `dob`, `email`, `passwd`, `sec_q`, `sec_a`, `mobile`) VALUES
(13, NULL, NULL, NULL, 'kaka@gmail.com', 'kaki', NULL, NULL, NULL),
(6, NULL, NULL, NULL, 'rooaat@gmail.com', 'aaa', NULL, NULL, NULL),
(5, NULL, NULL, NULL, 'rooat@gmail.com', 'a', NULL, NULL, NULL),
(3, NULL, NULL, NULL, 'root@gmail.com', 'b', NULL, NULL, NULL),
(12, NULL, NULL, NULL, 'ruddhi.borker@gmail.com', 'pop', NULL, NULL, NULL);
